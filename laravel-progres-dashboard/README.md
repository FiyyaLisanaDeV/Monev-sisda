...
Dashboard monitoring progres fisik, keuangan, dan risiko paket berbasis Laravel + Filament. Aplikasi ini membantu tim membaca kondisi pelaksanaan secara cepat melalui ringkasan eksekutif, analisis risiko, import Excel, dan tata kelola user berbasis role.

> Aplikasi ini tidak menyertakan kredensial di dokumentasi. Akun akses dikelola melalui administrator sistem atau modul Manajemen User.

## Preview

| Login Screen | Admin Dashboard |
| --- | --- |
| ![Login SISDA Monev](docs/screenshots/login.png) | ![Admin Dashboard SISDA Monev](docs/screenshots/admin-dashboard.png) |

## Navigasi Cepat

| Saya ingin... | Baca bagian |
| --- | --- |
| Melihat apa yang tersedia | [Mulai Dari Sini](#mulai-dari-sini) |
| Mengecek update terbaru | [Fitur Terbaru](#fitur-terbaru) |
| Melihat riwayat perbaikan | [Bug Fix Log](#bug-fix-log) |
| Memahami hak akses | [Peran Pengguna](#peran-pengguna) |
| Menjalankan project lokal | [Instalasi Lokal](#instalasi-lokal) |
| Menjalankan validasi | [Testing](#testing) |
| Mengecek aturan keamanan | [Catatan Keamanan](#catatan-keamanan) |
...
| Kelola akses | Manajemen User | Admin dapat menambah, mengubah role, dan menonaktifkan akses user. |
...
1. Admin menyiapkan akun dan role melalui Manajemen User.
2. Data progres diunggah melalui Import Batches.
3. Sistem membersihkan data, menyimpan jejak audit, dan membentuk data paket.
4. Dashboard menghitung serapan, gap fisik-keuangan, dan status risiko.
5. Tim memantau paket prioritas melalui Paket Berisiko dan modul analisis.

## Aturan Bisnis

### Pembersihan Data

- Angka dengan format rupiah, titik ribuan, koma desimal, atau persen dinormalisasi sebelum dihitung.
- Nilai kosong, `nan`, dan tanda `-` diperlakukan sebagai data kosong.
- Kolom dibaca dengan pendekatan toleran terhadap variasi nama kolom.

### Anti Double Counting

Sistem tidak memproses baris sebagai paket detail jika:

- Nama paket mengandung `TOTAL` atau `SUBTOTAL`.
- Kolom lokasi atau kode paket kosong.
- Baris terdeteksi sebagai agregat, bukan detail paket pekerjaan.

### Risk Scoring

| Status | Kondisi Umum |
| --- | --- |
| Kritis | Realisasi nol, serapan keuangan rendah, atau progres fisik rendah. |
| Perlu Perhatian | Serapan/progres berada di bawah ambang perhatian. |
| Perlu Review | Gap fisik dan keuangan terlalu jauh. |
| Aman | Tidak memenuhi kondisi risiko di atas. |

## Tata Kelola Data

- Data mentah import disimpan sebagai audit trail.
- Data hasil import tidak diedit manual sebagai sumber kebenaran.
- Koreksi dilakukan dari file sumber, lalu diimport kembali sebagai batch baru.
- Akses perubahan user dikelola lewat role dan policy aplikasi.
